...
//                Environment.getExternalStoragePublicDirectory() API 29 부터 deprecated 됨4
                //저장 경로 가져오기
                try {
        ...
        switch (requestCode) {
            case REQUEST_CODE:
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    //권하이 없으면 더이상 진행못하게 하든지 다른 조치를 취해야 한다.
                    // onDestroy();
    ...
    protected boolean checkExternalStorage() {
        ...
        if (Environment.MEDIA_MOUNTED.equals(state)) {   //mounted
            ...
            return true;
                ...
                Environment.MEDIA_MOUNTED_READ_ONLY.equals(state)) {     //mounted_ro
            //읽기 전용
            msg = "외부메모리 읽기만 가능";
            Log.d("myapp ", msg);
            Toast.makeText(this, msg, Toast.LENGTH_SHORT).show();
