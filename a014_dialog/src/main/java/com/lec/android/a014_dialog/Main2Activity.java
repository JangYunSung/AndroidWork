...
public class Main2Activity extends AppCompatActivity {
    ...
    protected AlertDialog.Builder showAlert(int id) { //id 값이 상수값을 받는다
        ...
        switch (id) {
            ...
            case DIALOG_MULTICHOICE:
                ...
                final boolean[] checked = {false, false, false, false};   //초기 화면 초기값

                builder4.setTitle("MultiChoice 다이얼로그")
                        .setPositiveButton("선택완료",
                                new DialogInterface.OnClickListener() {
                                    @Override
                                    public void onClick(DialogInterface dialog, int which) {
        ...
        return null;
    }//end AlertDialog.Builder showAlert()
