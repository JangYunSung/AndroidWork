...
public class Main3Activity extends AppCompatActivity {
    ...
    Button.OnClickListener mListener = new Button.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            {
                Toast.makeText(Main3Activity.this,"수를 입력하세요",Toast.LENGTH_SHORT).show();
            }
            switch (v.getId()) {
                case R.id.btn_add :
                ...
                case R.id.btn_del :
                    ...
                    Toast.makeText(Main3Activity.this,del_number,Toast.LENGTH_SHORT).show();
                    et_result.setText(del_number.substring(0,del_number.length() - 1));
                    break;

                case R.id.btn_result :
                    double result = 0;
                    Toast.makeText(Main3Activity.this, "결과", Toast.LENGTH_SHORT).show();
