...
//        unregisterForContextMenu(tvCtxMenu); // 뷰객체 (위젯 등 .. ) 에 등록된 ContextMenu 를 제거
    ...
    public void onCreateContextMenu(ContextMenu menu, View v, ContextMenu.ContextMenuInfo menuInfo) {
        ...
        // 각각의 뷰 (위젯) (v) 마다 다르게 메뉴 작동하도록 설정 가능
        switch (v.getId()) {
            case R.id.tvCtxMenu:
            ...
            case R.id.ivCtxView:
                ...
                menu.add(1, 1, 100, "그루트");
                menu.add(1, 2, 100, "팬서");
                menu.add(1, 3, 100, "스파이더맨");
                break;
...
// ContextMenu 의 메뉴아이템 항목을 선택(클릭) 했을 때 호출
    ...
    public boolean onContextItemSelected(@NonNull MenuItem item) {
        ...
        switch (groupId) {
            ...
            switch (id){
                case 1: //그루트
                    ivCtxMenu.setImageResource(R.drawable.face09);
                    return true;
